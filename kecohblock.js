! function() {
    function f() {
        ...
        a.innerHTML = '<div class="inner"> <
            ...
            <
            img src = "https://goo.gl/DxMpmF"
        alt = "Adblock" > < /li> <
            li > Choose, Don\ 't run on pages on this domain<br> <
            img src = "https://goo.gl/AWtmjA"
        alt = "Adblock"
        width = "auto" > < /li> <
            li > A new window will appear.Click on the "Exclude"
        button < br >
            <
            img src = "https://goo.gl/2Myn2z"
        alt = "Adblock" > < /li> <
            li > The browser icon should have turned grey < br >
            <
            img src = "https://goo.gl/dJG6jH"
        alt = "Adblock" > < /li> <
            li > Refresh the page
        if it didn\ 't refresh automatically. Thanks!</li> <
            /ol> <
            /div> <
            div class = "2" >
            <
            ...
            <
            img src = "https://goo.gl/ciwpWh"
        alt = "Adblock" > < /li> <
            li > Click on "Enabled on this site"
        position < br >
            <
            img src = "https://goo.gl/Z2ASxZ"
        alt = "Adblock"
        width = "auto" > < /li> <
            li > Once clicked, it should change to "Disabled on this site" < br >
            <
            img src = "https://goo.gl/w6CWAw"
        alt = "Adblock"
        width = "auto" > < /li> <
            li > The browser icon should have turned grey < br >
            <
            img src = "https://goo.gl/P6geir"
        alt = "Adblock" > < /li> <
            li > Refresh the page
        if it didn\ 't refresh automatically. Thanks!</li> <
            /ol> <
